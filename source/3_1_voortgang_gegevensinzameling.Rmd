...
include_graphics("../data/dummy_figuur.png")
```
...
Op basis van de ingevoerde bezoeken in [meetnetten.be](https://www.meetnetten.be), zien we dat sinds de opstart van de nieuwe soortenmeetnetten in 2016 al ongeveer 350 tellers (hoofdteller of medeteller) een telling uitvoerde. In totaal brachten deze tellers bijna 4700 bezoeken aan een van de meetnetlocaties.
...
* Amfibieën (ref toevoegen Speybroeck et al. 2019)
* Dagvlinders (ref toevoegen Maes et al. 2019)
* Libellen (ref toevoegen De Knijf et al. 2019)
* Planten (ref toevoegen Van Landuyt et al. 2019)
* Zoogdieren (ref toevoegen Van Den Berge et al. 2019)
* Kevers (ref toevoegen Thomaes et al. 2019)
* Spinnen (ref toevoegen Van Keer et al. 2019)
