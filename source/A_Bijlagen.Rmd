...
Onderstaande tabel geeft een overzicht van de Europese en Vlaams prioritaire soorten, de wijze waarop ze gemonitord worden en de status van de monitoring (indien een soort via een meetnet of een inhaalslag gemonitord wordt).
